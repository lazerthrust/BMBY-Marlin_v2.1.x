...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_OCTOPUS_V1_1  //LTJB
#endif
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 -1 //LTJB USB
#define BAUDRATE_2 115200   // LTJB :[2400, 9600, 19200, 38400, 57600, 115200, 250000, 500000, 1000000] Enable to override BAUDRATE
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_3 2 //LTJB RPI
#define BAUDRATE_3 115200   // LTJB :[2400, 9600, 19200, 38400, 57600, 115200, 250000, 500000, 1000000] Enable to override BAUDRATE

// Enable the Bluetooth serial interface on AT90USB devices
//#define BLUETOOTH

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "Meast Me Meast You" //LTJB
 ...
 */
#define X_DRIVER_TYPE  DRV8825 //LTJB
#define Y_DRIVER_TYPE  DRV8825 //LTJB
#define Z_DRIVER_TYPE  DRV8825 //LTJB
...
#define E0_DRIVER_TYPE DRV8825 //LTJB
...
#define DEFAULT_NOMINAL_FILAMENT_DIA 2.85 //LTJB
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  24.23 //LTJB
    #define DEFAULT_Ki   1.54 //LTJB
    #define DEFAULT_Kd 95.29  //LTJB
  #endif
#else
...
#define PIDTEMPBED //LTJB
  ...
  #define DEFAULT_bedKp 104.45  //LTJB
  #define DEFAULT_bedKi 20.24   //LTJB 
  #define DEFAULT_bedKd 359.38  //LTJB
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 5, 25 } //LTJB

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 300, 200, 10, 50 } // LTJB ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 400, 400, 25, 400 } //LTJB

//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 500, 500, 100, 500 } // LTJB ...or, set your own edit limits
#endif
 ...
 */
#define DEFAULT_ACCELERATION          300    // LTJB X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  300    // LTJB E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   300   // LTJB X, Y, Z acceleration for travel (non printing) moves
...
#define USE_PROBE_FOR_Z_HOMING  //LTJB
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -33.5, -33.5, -1.20 }  //LTJB
...
#define Z_CLEARANCE_FOR_HOMING  10 // LTJB (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
 ...
 */
#define FILAMENT_RUNOUT_SENSOR  //LTJB
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 100 //LTJB

  #define FILAMENT_RUNOUT_THRESHOLD 100 //LTJB
...
#define AUTO_BED_LEVELING_BILINEAR  //LTJB
 ...
 */
#define RESTORE_LEVELING_AFTER_G28  //LTJB
//#define ENABLE_LEVELING_AFTER_G28

/**
 * Auto-leveling needs preheating
 */
#define PREHEAT_BEFORE_LEVELING //LTJB
#if ENABLED(PREHEAT_BEFORE_LEVELING)
  #define LEVELING_NOZZLE_TEMP 120   // (°C) Only applies to E0 at this time
  #define LEVELING_BED_TEMP     110 //LTJB
#endif
 ...
 */
#define EEPROM_SETTINGS     // LTJB Persistent storage with M500 and M501
...
#define PREHEAT_1_TEMP_CHAMBER 0  //LTJB
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "HIPS"  //LTJB
#define PREHEAT_2_TEMP_HOTEND 245
#define PREHEAT_2_TEMP_BED    115
#define PREHEAT_2_TEMP_CHAMBER 0  //LTJB
...
//#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 50), (Y_MIN_POS + 10), 20 }  //LTJB
...
//
#define REVERSE_ENCODER_DIRECTION //LTJB
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU //LTJB
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 2  //LTJB
#define LCD_FEEDBACK_FREQUENCY_HZ 5000        //LTJB
...
//
#define STARTUP_TUNE { 698, 300, 0, 50, 523, 50, 0, 25, 494, 50, 0, 25, 523, 100, 0, 50, 554, 300, 0, 100, 523, 300 } //LTJB
...
//
#define REPRAP_DISCOUNT_SMART_CONTROLLER  //LTJB
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER //LTJB

#define ST7920_DELAY_1 DELAY_NS (250)  //LTJB delays to fix screen comms issues - lines and corrupt image
#define ST7920_DELAY_2 DELAY_NS (400)   //LTJB
#define ST7920_DELAY_3 DELAY_NS (250)   //LTJB
